...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        {
            public static Color Background = Color.FromArgb(20, 24, 30); // Modern soft charcoal
            public static Color Panel = Color.FromArgb(30, 35, 43);      // Connection hub card
            public static Color Panel2 = Color.FromArgb(45, 52, 62);     // Hover/active states
            public static Color Green = Color.FromArgb(0, 255, 65);      // #00FF41
            public static Color Orange = Color.FromArgb(255, 184, 0);    // #FFB800
            public static Color White = Color.White;
            public static Color Border = Color.FromArgb(60, 70, 85);     // Subtle border
        }
        ...
        private void ApplyRoundedCorners(Control ctrl, int radius)
        {
            ...
            var path = RoundedRect(ctrl.ClientRectangle, radius);
